            ...
            <div class="row">
              <div class="col-md-6 shipping-calculator-form">
                ...
                <div class="row row-10">
                  <div class="col-sm-12">
                    <p class="form-row form-row-wide">
                      <input type="text" class="input-text berat" value placeholder="Berat" name="berat" id="Berat" readonly>
                    </p>
                  </div>
                </div>
  ...
  $(function(){
          ...
          $('.update-total').click(function(e){
              ...
              $('input[name="size[]"]').each(function(){
                  // Misalnya, anggap setiap karakter ukuran produk mewakili berat
                  totalBerat += parseInt($(this).val());
              });

              // Memasukkan total berat ke dalam input berat
