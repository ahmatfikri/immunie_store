          ...
          <div class="row">
            ...
            <div class="ecommerce col-xs-12">
              ...
              <form name="checkout" class="checkout ecommerce-checkout row" method="POST" action="/payments">
                    @csrf
                    <input type="hidden" name="id_order" value="{{$latestOrders->id}}">
                    <div class="col-md-8" id="customer_details">
                        <div>
                            ...
                            <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                ...
                                <input type="text" class="input-text" placeholder value="{{ $grandTotal }}" name="jumlah" id="billing_first_name">
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <strong><span class="amount">Rp.
                                                {{ number_format($latestOrders->grand_total) }}</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
