                    ...
                    <div class="col-md-12">
                        <form class="form-kategori">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ukuran" placeholder="Berat Prooduk">
                            </div>
                            <div class="form-group">
            ...
            success: function({
                ...
                data.map(function(val, index) {
                    row += `
                        <tr>
                            <td>${index+1}</td>
                            <td>${val.category ? val.category.nama_kategori : 'N/A'}</td>
                            <td>${val.subcategory ? val.subcategory.nama_subkategori : 'N/A'}</td>
    ...
    $.ajax({
        ...
        success: function({
            ...
            data.map(function(val, index) {
                ...
                if (val.nama_barang.toLowerCase().includes(searchTerm)) {
                    row += `
                        <tr>
                            <td>${index+1}</td>
                            <td>${val.category ? val.category.nama_kategori : 'N/A'}</td>
